...
\lstset{
    ...
    breakatwhitespace=false,        % Break lines anywhere, not just at whitespace
    postbreak=\mbox{\textcolor{red}{$\hookrightarrow$}\space}, % Show continuation symbol
    ...
    xleftmargin=\parindent,         % Indent code blocks
