...
\subsubsection{Snippet 1 (User Story Name)}
...
\textbf{Description:} This function takes 2 arguments. Then we have an infinite loop that swaps the value of the two passed variables.
...
\itemheading{Test Case Name}

Execute the Test Case you planned in Chapter 2 by prodiving inputs and then report the finding whether the testcase passed or failed.
...
\begin{xltabular}{\textwidth}{|X|X|}
    ...
    \hiderowcolors
    \caption{Test Case 1} \label{tab:test_case_ch4_2} \\
    \hline
    \showrowcolors
